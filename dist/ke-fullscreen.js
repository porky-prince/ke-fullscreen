...
var api = require('./compatibility.js');
...
var Fullscreen = function () {
    ...
    _createClass(Fullscreen, [{
        ...
        /**
         * Determine whether fullscreen mode is available.
         *
         * 判断全屏模式是否是可用。
         * @example
         ...
         * 因为它始终返回false，只能用来判断fullscreen.launch()启动的全屏，
         * 这里可以将isNoScroll设置为true来判断。
         *
         * 这个方法可以用来判断所有主流浏览器当页面不出现滚动条时，用户是否是按了f11后的全屏(ie9+;edge没有f11键全屏这个功能)。
         *
        ...
        key: 'isFullscreen',
        value: function isFullscreen(isNoScroll) {
        ...
        key: 'launch',
        value: function launch(element, fn) {
         ...
         *    }else{
         *        alert("Sorry,Your browser version is too low to support fullscreen, please upgrade or press F11 for fullscreen.");
         *    }
         *};
         *
         * function launch() {
        ...
        key: 'toggle',
        value: function toggle(element, launchFn, exitFn) {
        ...
        key: 'preventDefault',
        value: function preventDefault(fn) {
